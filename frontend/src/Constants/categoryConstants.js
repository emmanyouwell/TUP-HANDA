...
export const ARCHIVED_CATEGORY_REQUEST = 'ARCHIVED_CATEGORY_REQUEST'
export const ARCHIVED_CATEGORY_SUCCESS = 'ARCHIVED_CATEGORY_SUCCESS'
export const ARCHIVED_CATEGORY_FAIL = 'ARCHIVED_CATEGORY_FAIL'
...
export const RESTORE_CATEGORY_RESET = 'RESTORE_CATEGORY_RESET'
export const RESTORE_CATEGORY_FAIL = 'RESTORE_CATEGORY_FAIL'
