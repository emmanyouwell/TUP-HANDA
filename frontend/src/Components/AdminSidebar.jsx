...
export function AdminSidebar() {
  ...
  return (
    <>
      {isDesktopOrLaptop ? <Card className="h-screen w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5">
        ...
        <div onClick={toggleDrawer} className='text-3xl w-[auto] sticky top-0 left-0 p-10 cursor-pointer lg:hidden z-20'>
