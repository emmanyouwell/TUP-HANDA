    ...
    <div className='flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 min-h-screen'>
      <div className='min-w-md w-full space-y-8'>
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-4 md:-mt-14 lg:-mt-16 xl:-mt-20 mb-10">
            <div className="col-span-full flex justify-center items-center">
              <img src={myImage} alt="Page not found" className='md:w-[60%] hidden sm:block' />
            </div>
            <div className='flex flex-wrap justify-center items-center col-span-full'>
    <button className="bg-yellow-700 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded-full transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 m-2 sm:m-5" onClick={notify}>
        Eili
    </button>
    <button className="bg-yellow-700 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded-full transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 m-2 sm:m-5" onClick={notify}>
        Maye
