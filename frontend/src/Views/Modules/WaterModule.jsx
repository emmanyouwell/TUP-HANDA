            ...
            <div className="overflow-x-hidden overflow-y-hidden">
                ...
                <div className="relative min-h-screen p-10">
                    ...
                    <div className="grid grid-auto-flow:column grid-cols-4 gap-4 z-10 relative">
                        <div className="typhoon col-span-2 flex flex-col justify-center items-align h-full w-full bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 p-4 text-white" data-aos="fade-right">
                        ...
                        <div className="typhoon row-span-2 flex flex-col justify-center items-align h-full w-full bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 p-4 text-white" data-aos="fade-right">
                        ...
                        <div className="typhoon flex flex-col justify-center items-align h-full w-full bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 p-4 text-white" data-aos="fade-left">
                        ...
                        <div className="typhoon col-span-2 flex flex-col justify-center items-align h-full w-full bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 p-4 text-white" data-aos="fade-up">
                ...
                <div className="relative min-h-screen p-10">
                    ...
                    <div className="grid grid-auto-flow:column grid-cols-4 gap-4 z-10 relative">
                        ...
                        <div className="typhoon col-span-2 flex flex-col justify-center items-align h-full w-full bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 p-4 text-white" data-aos="fade-left">
                        ...
                        <div className="typhoon flex flex-col justify-center items-align h-full w-full bg-white-900 rounded-md bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-40 border border-gray-100 p-4 text-white" data-aos="fade-right">
