...
import { clearErrors, getModuleDetails, updateModule } from '../../../Actions/modulesActions'
                                        ...
                                        <div className="col-span-full">
                                            <div className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                ...
                                                >
                                                    ...
                                                    {filename ? <span className="pl-5">{filename}</span> : modules && modules.file && <a href={modules.file.url} target="_blank" rel="noreferrer" className="text-indigo-600 pl-5 text-md">{modules.title}.pdf</a>}
                                                </label>
